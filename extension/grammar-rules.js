...
const GSB_GRAMMAR_RULES = [
  ...
  // --- Subject-verb agreement ---
  {
    ...
    message: (m) => `"${m[1]}" is plural — try "are" instead.`,
  ...
  },
  {
    ...
    message: (m) => `"${m[1]}" takes "is" — try that instead of "are".`,
  ...
  },
  {
    id: "sv-i-is",
    pattern: /\bI\s+is\b/g,
    message: () => `Hmm, this should be "I am" — not "I is".`,
    suggestion: () => "I am",
    type: "grammar"
  },
  {
    ...
    message: () => `Looks like this needs "were" — try "you were" instead.`,
  ...
  },
  {
    ...
    message: () => `This should be "we were" — not "we was".`,
    suggestion: (m) => m[0].replace(/\bwas\b/i, "were"),
    type: "grammar"
  },
  {
    ...
    message: () => `Try "they were" instead of "they was".`,
    suggestion: (m) => m[0].replace(/\bwas\b/i, "were"),
    type: "grammar"
  },
  ...
  },
  {
    ...
    message: () => `For comparisons, use "than" — not "then".`,
  ...
  },
  {
    ...
    message: () => `As a noun, this should be "effect" — not "affect".`,
  ...
  },
  {
    ...
    message: () => `Did you mean "too" (also or too much) here?`,
  ...
  // --- Double words ---
  {
    ...
    message: (m) => `Looks like "${m[1]}" got repeated — probably a typo.`,
    suggestion: (m) => m[1],
    type: "grammar"
  },
  ...
  //   eu-words: European, eulogy, euphoria, eucalyptus
  {
    ...
    message: () => `Try "an" before words that start with a vowel sound.`,
    suggestion: (m) => "an " + m[1],
    type: "grammar",
  ...
  //   acronyms/letters: an FBI, an MBA, an HTML (pronounced with vowel sounds)
  {
    ...
    message: () => `Try "a" before words that start with a consonant sound.`,
    suggestion: (m) => "a " + m[1],
    type: "grammar",
  ...
  // --- Verb tense ---
  {
    ...
    message: () => `With he/she/it, use "has" — not "have".`,
  ...
  },
  {
    ...
    message: (m) => `"${m[1]}" needs "have" — not "has".`,
  ...
  },
  {
    ...
    message: (m) => `After "did", use the simple form of the verb — not the past tense.`,
    suggestion: (m) => {
      const pastToBase = {
  ...
  // --- Punctuation helpers ---
  {
    ...
    message: () => `You might add a comma before the conjunction here — it depends on how long your clauses are.`,
  ...
  // --- Common mistakes ---
  {
    ...
    message: () => `This should be "have" — like "could have" — not "of".`,
  ...
  },
  {
    ...
    message: (m) => `This should be "${m[1]}d to" — with the "d" at the end.`,
  ...
  },
  {
    ...
    message: () => `"Irregardless" isn't a standard word — try "regardless" instead.`,
  ...
  },
  {
    ...
    message: () => `"Alright" is pretty informal — "all right" is more formal if you need it.`,
  ...
  },
  {
    ...
    message: () => `Did you mean "lose" (to misplace or fail)? "Loose" means not tight.`,
